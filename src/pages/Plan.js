        ...
        <>
            <div className="relative w-screen overflow-hidden">
                ...
                <div className="relative pb-32 3xl:mb-40">
                    <div className=" text-center text-4xl text-purple lg:text-6xl font-spoof px-3 md:px-32 pt-20" data-aos="fade-in">
                    ...
                    <div className="flex flex-col justify-evenly items-center gap-8 lg:items-start lg:flex-row px-5 md:px-24">
                        <div className="bg-white rounded-xl w-full sm:w-[592px] p-4 2xl:w-[670px]" data-aos="fade-up">
                            ...
                            <button type="submit" className="w-full font-spoof font-bold text-lg bg-yellow hover:bg-dark-red hover:text-white rounded-3xl p-3 " onClick={() => navigate('/signup')}>Subscribe Now</button>
                        ...
                        <div className="bg-white rounded-xl w-full sm:w-[592px] p-4 2xl:w-[670px]" data-aos="fade-up">
                            ...
                            <button type="submit" className="w-full text-lg bg-white font-spoof text-dark-red border hover:bg-dark-red hover:text-white border-dark-red rounded-3xl p-3 mt-3" onClick={() => navigate('/contactsales')}>Contact Sales</button>
